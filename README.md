...
HTML templating engine for [React](http://facebook.github.io/react/index.html) and [TypeScript](https://github.com/Microsoft/TypeScript).

* write templates in plain HTML, compile to TypeScript (.tsx) and use like any other React component.
* Highly inspired to [react-templates](https://github.com/wix/react-templates).
